...
#define AXIS_RELATIVE_MODES { false, false, false, true, true }
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 10*60, 10*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
