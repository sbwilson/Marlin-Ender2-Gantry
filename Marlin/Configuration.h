...
#define STRING_CONFIG_H_AUTHOR "(Simon Wilson)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CamPlatform"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 20, 20 }
