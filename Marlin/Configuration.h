...
#define STRING_CONFIG_H_AUTHOR "(Net5 Health Systems, Ender 2 Gantry)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Gantry"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 3000, 3000, 60, 25 }
